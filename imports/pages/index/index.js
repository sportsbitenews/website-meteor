...
// import { Strings } from '/imports/api/strings.js';
const Strings = {
  find: () => {}
}
      ...
      <div className="container">
        ...
        <div className="content">
          <div className="column">
            ...
            <div id="play-sims" className="phet-button"><span dangerouslySetInnerHTML={{__html: this.renderTranslatedString( 'playButton' )}} /></div>
          </div>
          <div className="column">
